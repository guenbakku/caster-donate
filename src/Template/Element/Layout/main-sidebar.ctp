<aside class="main-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="active treeview">
            <a href="#">
                <i class="fa fa-pie-chart"></i> <span><?=__('Thống kê')?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li class="active"><a href="/me/statistics"><i class="fa fa-circle-o"></i> <?=__('Thu nhập')?></a></li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li class="active"><a href="/me/profile"><i class="fa fa-circle-o"></i> <?=__('Thông tin tài khoản')?></a></li>
                <li><a href="/me/contract"><i class="fa fa-circle-o"></i> <?=__('Thông tin Lên Sóng')?></a></li>
            </ul>
        </li>
        <li>
            <a href="/me/schedule">
