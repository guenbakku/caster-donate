...

{
    ...
    public function notify()
    {
        ...
        $DonationNotificationSettingLg = new DonationNotificationSetting();
        $ResourcesLg = new Resources();
        $image_resources = $ResourcesLg->getAllAvailableResources($user_id,'image');
        $audio_resources = $ResourcesLg->getAllAvailableResources($user_id,'audio');
        
        if ($this->request->is('put')) {
            $new_donation_notification_setting = $this->request->getData();
            $new_donation_notification_setting = $DonationNotificationSettingLg->edit($user_id, $new_donation_notification_setting);
        ...
        $donation_notification_setting = $DonationNotificationSettingLg->get($user_id);
